...
Rails.application.configure do
  ...
  # Full error reports are disabled but SIT may show more detailed errors than production.
  ...
  config.action_mailer.default_url_options = {
    host: ENV.fetch('MAILER_HOST', 'sit.example.com'),
    protocol: 'https'
  }
  ...
  config.action_mailer.smtp_settings = {
    ...
    domain: ENV.fetch('SMTP_DOMAIN', 'sit.example.com'),
